package sn.esmt.offreemploieand.model;
...
public class CvEntities {
    ...
    public CvEntities(int id, String nom, String prenom, int age, String adresse, String email, String telephone, String specialite,String niveauEtude, String experienceProfessionnelle ) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        this.age = age;
